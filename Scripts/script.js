...
function loginUser(event) {
   ...
   console.log(validarClave('claveMensaje2')) 
    if(validarClave('claveMensaje2')==='validated'){
        alert('Completa todos los campos');
        event.preventDefault();
    }else if (validarClave('claveMensaje2')) {
        event.preventDefault();
        alert('Tu clave no cumple los requisitos');
...
// Funcion que valida la clave en tiempo real dependiendo que input este leyendo
    ...
    // Recuperar contraseña al hacer clic en "olvidaste tu contraseña"
const olvidasteContrasenaBtn = document.getElementById('enlaceFalso');

    olvidasteContrasenaBtn.addEventListener('click', function() {
